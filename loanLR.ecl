export loanLR := module;
EXPORT MyRecord := RECORD
    STRING id;
    STRING member_id;
    STRING loan_amnt; 
    STRING funded_amnt;  
    ...
    STRING issue_d ; 
    STRING loan_status; //QUALITATIVE DATA  
    STRING pymnt_plan ; 
    STRING url ; 
    STRING desc ; 
    STRING purpose ; 
...
EXPORT file := DATASET('~online::andrew::accepted_2007_to_2018q4.csv', MyRecord, CSV(HEADING(1)));

export MLloan:= RECORD
    unsigned8 id;
    decimal loan_amnt;
    unsigned8 int_rate;
    unsigned8 fico_range_low;
    decimal annual_inc;
    decimal dti;
